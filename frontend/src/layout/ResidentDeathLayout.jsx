...
const ResidentDeathLayout = ({ children }) => { 
        ...
        <div className='md:col-span-2 sm:col-span-7 md:h-[88vh] sm:h-[60vh] w-full border'>
          <div className='border p-6 border-t-0'>
            ...
            <div className='flex flex-col justify-start items-start w-full '>
              ...
              <NavLink to="/ResidentDashboards/deathCertificate/request" className={mainhover}>
              Request
              </NavLink>

              <NavLink to="/ResidentDashboards/deathCertificate/documentStatus" className={mainhover}>
              Document Status
              </NavLink>
            </div>
        </div>
...
export default ResidentDeathLayout;
