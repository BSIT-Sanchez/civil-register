        ...
        <div className='md:col-span-2 sm:col-span-7 md:h-[88vh] sm:h-[60vh] w-full border'>
          <div className='border p-6 border-t-0'>
            ...
            <div className='flex flex-col justify-start items-start w-full '>
              ...
              <NavLink to="/AdminDashboards/birthCertificate/issuance" className={mainhover}>
               Issuance  of Certificate
              </NavLink>

              <NavLink to="/AdminDashboards/birthCertificate/records" className={mainhover}>
               Records
              </NavLink>
            </div>
        </div>
