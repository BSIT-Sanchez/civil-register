...
const ResidentLayout = ({children , isOpen, setIsOpen}) => {
        ...
        <div className="flex flex-col gap-1 w-full">
          ...
          <div className='border-t-[.01px] border-[#6b7280] w-full '>
            <div className='flex flex-col w-[93%] mx-2 mt-6 mb-8 '>
                ...
                <NavLink to="/ResidentDashboard" className={mainHover}>
                  <div>
                      <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                ...
                <NavLink to="/ResidentDashboards/users" className={mainHover} onClick={handlerUser}>
                          <div>
                            <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                    ...
                    >
                      ...
                      />
                          ...
                          <div className='flex justify-between items-center w-full'>
                            <h1 className='font-[500] '>Document Status</h1>
                          </div>
                ...
                >
                  ...
                  { userlists && (
                      ...
                      <NavLink to='/ResidentDashboards/birthCertificate' className={mainHover} >                                    
                        <h1 className='text-[13px] font-[600] pl-[2rem]'>Birth Certificate</h1>
                      </NavLink> 
                      <NavLink to='/ResidentDashboards/marriageCertificate' className={mainHover}>                                    
                        <h1 className='text-[13px] font-[600] pl-[2rem]'>Marriage Certificate</h1>
                      </NavLink>
                      <NavLink to='/ResidentDashboards/deathCertificate' className={mainHover}>                                    
                  ...
                  <NavLink to='/ResidentDashboards/announcements' className={mainHover}>
                      <div>
                        <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
      ...
      <div className={`xs:w-[96%] xs:mx-[2%] ${isOpen ? ' lg:w-[78%] lg:ml-[19rem]  h-[100%] custom-scrollbar  ' : ' lg:w-full h-[100%] custom-scrollbar '} overflow-auto`} >
        ...
        <div className={`hidden lg:block bg-bgHeader  box-shadow border-b-[1px] border-[#e1e0e4] dark:border-darkHeader border-solid  ${isOpen ? 'left-[19rem] ' : 'left-2 right-8 top-2'}`}>
          <div className="flex p-3 justify-between items-center">
            ...
            <div className='relative w-[35px] h-[35px] text-[#93A3BC] font-semibold cursor-pointer hover:bg-slate-300 rounded-[50%] hover:bg-opacity-[.03] p-[7px]'>
              <img src="/banner.jpg" alt='profile-icon' className='w-[21px] h-[21px] font-semibold cursor-pointer' onClick={handlerProfile} />
              ...
              {/**Profile modal */}
              {
                ...
                <div className='absolute bg-[#ffffff] right-[.5rem] w-[10rem] h-[10rem] mt-[12px] rounded-[5px] shadow-lg z-[1000]'>
                  ...
                  <div className='border-b-[.01px] border-[#e5e8eb]'>
                    <NavLink to="/Profile/Account" className='hover:bg-gray-900 hover:bg-opacity-[.12] cursor-pointer p-2 my-[4px] w-full flex justify-start items-center gap-4'>
              ...
              <div className={`absolute top-[58px] left-0 w-[100%] h-[90vh] bg-[#1c008b] rounded-[7px] ransition-transform duration-300 transform z-[1000] ${
                ...
                >
                  ...
                  { userlists && (
                      ...
                      <NavLink to='/ResidentDashboards/marriageCertificate/registration' className={mainHover}>                                    
                        <h1 className='text-[13px] font-[600] pl-[2.4rem]'>Marriage Certificate</h1>
                      </NavLink>
                      <NavLink to='/ResidentDashboards/deathCertificate/registration' className={mainHover}>                                    
