...
const ResidentMarriageLayout = ({ children }) => { 
    ...
    <div className='grid md:grid-cols-7 sm:grid-cols-1 w-full gap-1  '>
        <div className='md:col-span-2 sm:col-span-7 md:h-[88vh] sm:h-[60vh] w-full border'>
          <div className='border p-6 border-t-0'>
            <h1 className='font-[900] text-[22px] text-gray-900  text-center md:pb-8 sm:pb-0'>Marriage Certificate</h1>
          </div>
            ...
            <div className='flex flex-col justify-start items-start w-full '>
              ...
              <NavLink to="/ResidentDashboards/marriageCertificate/request" className={mainhover}>
               Request
              </NavLink>

              <NavLink to="/ResidentDashboards/marriageCertificate/documentStatus" className={mainhover}>
              Document Status
              </NavLink>
            </div>
        </div>
...
export default ResidentMarriageLayout;
