...
const ResidentDeathCertificate = () => {
      ...
      <ResidentDeathLayout>
         <div className={`bg-[#b8babe] w-full h-[88vh] overflow overflow-y-scroll sidebar ${isOpen ? 'w-[106%]' : 'w-full'}`}>
          <div className='pt-2 mb-3'>
            <h1 className='text-center font-bold text-[23px]'>DEATH CERTIFICATE REGISTRATION FORM</h1>
          </div>
          <div className='m-4'>
...
export default ResidentDeathCertificate;
